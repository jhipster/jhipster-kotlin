...
const { CASSANDRA, H2_DISK, H2_MEMORY, MONGODB, NEO4J, SQL } = require('generator-jhipster/jdl/jhipster/database-types');
...
const serviceDiscoveryTypes = require('generator-jhipster/jdl/jhipster/service-discovery-types');
...
function askForKotlinServerSideOpts() {
    ...
    return this.prompt(prompts).then(answers => {
        ...
        // config coroutine
        if (this.reactive) {
            this.coroutine = this.jhipsterConfig.coroutine = answers.coroutine;
        }
