...
const baseServerFiles = {
    ...
    serverJavaAuthConfig: [
        ...
        },
        {
            ...
            templates: [
                {
                    file: 'coroutine/security/DomainUserDetailsService.java',
        ...
        },
        {
            ...
            templates: [
                ...
                {
                    file: 'coroutine/web/rest/UserJWTController.java',
    ...
    serverJavaGateway: [
        ...
        {
            condition: generator =>
                generator.authenticationTypeOauth2 && (generator.applicationTypeMonolith || generator.applicationTypeGateway),
            path: SERVER_MAIN_SRC_DIR,
            templates: [
                {
    ...
    serverJavaDomain: [
        {
            path: SERVER_MAIN_SRC_DIR,
            templates: [
                { file: 'package/domain/package-info.java', renameTo: generator => `${generator.javaDir}domain/package-info.java` },
            ],
        },
        {
            condition: generator =>
            ...
            templates: [
                {
                    ...
                    renameTo: generator =>
                        `${generator.javaDir}web/filter/OAuth2${generator.reactive ? 'Reactive' : ''}RefreshTokensWebFilter.java`,
                },
            ],
        },
        {
            ...
            templates: [
                {
                    file: 'package/test/util/OAuth2TestUtil.java',
                    renameTo: generator => `${generator.testDir}test/util/OAuth2TestUtil.java`,
                },
            ],
        },
    ],
    ...
    serverJavaUserManagement: [
        ...
        },
        {
            ...
            templates: [
                ...
                {
                    file: 'coroutine/repository/AuthorityRepository.java',
        ...
        },
        {
            ...
            templates: [
                ...
                { file: 'coroutine/service/UserService.java', renameTo: generator => `${generator.javaDir}service/UserService.java` },
                {
        ...
        },
        {
            ...
            templates: [
                ...
                {
                    file: 'coroutine/repository/UserRepository.java',
                    renameTo: generator => `${generator.javaDir}repository/UserRepository.java`,
                },
                {
                    file: 'coroutine/web/rest/PublicUserResource.java',
        ...
        },
        {
            ...
            templates: [
                {
                    file: 'coroutine/web/rest/AccountResource.java',
        ...
        },
        {
            ...
            templates: [
                ...
                { file: 'coroutine/web/rest/UserResource.java', renameTo: generator => `${generator.javaDir}web/rest/UserResource.java` },
                {
                    file: 'coroutine/web/rest/PublicUserResource.java',
                    renameTo: generator => `${generator.javaDir}web/rest/PublicUserResource.java`,
                },
