...
function writeFiles() {
    return {
        ...
        cleanupOldServerFiles() {
            ...
            cleanup.cleanupOldServerFiles(this, this.kotlinDir, this.kotlinTestDir);
        },
        ...
        writeServerJavaAuthConfigFiles() {
            ...
            if (this.authenticationType === 'session') {
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/domain/PersistentToken.kt.ejs`), `${kotlinDir}domain/PersistentToken.kt`);
            ...
            if (this.authenticationType === 'oauth2') {
                ...
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/security/DomainUserDetailsService.kt.ejs`), `${kotlinDir}security/DomainUserDetailsService.kt`);
            ...
            if (this.authenticationType === 'jwt') {
                ...
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/UserJWTController.kt.ejs`), `${kotlinDir}web/rest/UserJWTController.kt`);
            }
            ...
            if (this.enableSocialSignIn) {
                ...
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/domain/SocialUserConnection.kt.ejs`), `${kotlinDir}domain/SocialUserConnection.kt`);
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/CustomSocialConnectionRepository.kt.ejs`), `${kotlinDir}repository/CustomSocialConnectionRepository.kt`);
                ...
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/SocialUserConnectionRepository.kt.ejs`), `${kotlinDir}repository/SocialUserConnectionRepository.kt`);
                ...
                this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/security/social/package-info.java.ejs`), `${javaDir}security/social/package-info.java`);
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/SocialService.kt.ejs`), `${kotlinDir}service/SocialService.kt`);
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/SocialController.kt.ejs`), `${kotlinDir}web/rest/SocialController.kt`);
            }
        },
        ...
        writeServerJavaGatewayFiles() {
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/GatewayResource.kt.ejs`), `${kotlinDir}web/rest/GatewayResource.kt`);
        ...
        writeServerJavaAppFiles() {
            // Create Java files
            // Spring Boot main
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/Application.kt.ejs`), `${kotlinDir}/${this.mainClass}.kt`);
        },

        writeServerJavaConfigFiles() {
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/aop/logging/LoggingAspect.kt.ejs`), `${kotlinDir}aop/logging/LoggingAspect.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/config/DefaultProfileUtil.kt.ejs`), `${kotlinDir}config/DefaultProfileUtil.kt`);

            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/config/package-info.java.ejs`), `${javaDir}config/package-info.java`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/config/AsyncConfiguration.kt.ejs`), `${kotlinDir}config/AsyncConfiguration.kt`);
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/config/DateTimeFormatConfiguration.kt.ejs`), `${kotlinDir}config/DateTimeFormatConfiguration.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/config/LoggingConfiguration.kt.ejs`), `${kotlinDir}config/LoggingConfiguration.kt`);
            ...
            if (this.databaseType === 'couchbase') {
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/N1qlCouchbaseRepository.kt.ejs`), `${kotlinDir}repository/N1qlCouchbaseRepository.kt`);
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/CustomN1qlCouchbaseRepository.kt.ejs`), `${kotlinDir}repository/CustomN1qlCouchbaseRepository.kt`);
            }

            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/config/ApplicationProperties.kt.ejs`), `${kotlinDir}config/ApplicationProperties.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/config/JacksonConfiguration.kt.ejs`), `${kotlinDir}config/JacksonConfiguration.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/config/LocaleConfiguration.kt.ejs`), `${kotlinDir}config/LocaleConfiguration.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/config/LoggingAspectConfiguration.kt.ejs`), `${kotlinDir}config/LoggingAspectConfiguration.kt`);
        ...
        writeServerJavaDomainFiles() {
            ...
            if (this.databaseType === 'sql' || this.databaseType === 'mongodb' || this.databaseType === 'couchbase') {
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/domain/AbstractAuditingEntity.kt.ejs`), `${kotlinDir}domain/AbstractAuditingEntity.kt`);
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/domain/PersistentAuditEvent.kt.ejs`), `${kotlinDir}domain/PersistentAuditEvent.kt`);
            }
        },
        ...
        writeServerJavaServiceFiles() {
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/util/RandomUtil.kt.ejs`), `${kotlinDir}service/util/RandomUtil.kt`);
        },
        ...
        writeServerJavaWebFiles() {
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/LogsResource.kt.ejs`), `${kotlinDir}web/rest/LogsResource.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/ProfileInfoResource.kt.ejs`), `${kotlinDir}web/rest/ProfileInfoResource.kt`);
        },
        ...
        writeJavaUserManagementFiles() {
            ...
            if (this.skipUserManagement) {
                if (this.authenticationType === 'oauth2') {
                    ...
                    this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/AccountResource.kt.ejs`), `${kotlinDir}web/rest/AccountResource.kt`);
                    this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/domain/User.kt.ejs`), `${kotlinDir}domain/User.kt`);
                    ...
                    if (this.applicationType === 'monolith') {
                        ...
                        this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/domain/Authority.kt.ejs`), `${kotlinDir}domain/Authority.kt`);
                        this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/UserService.kt.ejs`), `${kotlinDir}service/UserService.kt`);
                        ...
                        this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/mapper/UserMapper.kt.ejs`), `${kotlinDir}service/mapper/UserMapper.kt`);
                        this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/UserRepository.kt.ejs`), `${kotlinDir}repository/UserRepository.kt`);
                        this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/AuthorityRepository.kt.ejs`), `${kotlinDir}repository/AuthorityRepository.kt`);
                        this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/UserResource.kt.ejs`), `${kotlinDir}web/rest/UserResource.kt`);
                        if (this.searchEngine === 'elasticsearch') {
                        ...
                        if (this.databaseType === 'sql' || this.databaseType === 'mongodb') {
                            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/CustomAuditEventRepository.kt.ejs`), `${kotlinDir}repository/CustomAuditEventRepository.kt`);
                            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/AuthorityRepository.kt.ejs`), `${kotlinDir}repository/AuthorityRepository.kt`);
                            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/repository/PersistenceAuditEventRepository.kt.ejs`), `${kotlinDir}repository/PersistenceAuditEventRepository.kt`);
                            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/AuditEventService.kt.ejs`), `${kotlinDir}service/AuditEventService.kt`);
                            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/AuditResource.kt.ejs`), `${kotlinDir}web/rest/AuditResource.kt`);
                            this.template(rewriteDir(`${SERVER_TEST_SRC_KOTLIN_DIR}package/repository/CustomAuditEventRepositoryIntTest.kt.ejs`), `${kotlinTestDir}repository/CustomAuditEventRepositoryIntTest.kt`);
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/UserService.kt.ejs`), `${kotlinDir}service/UserService.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/MailService.kt.ejs`), `${kotlinDir}service/MailService.kt`);
            if (this.databaseType === 'sql' || this.databaseType === 'mongodb' || this.databaseType === 'couchbase') {
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/AuditEventService.kt.ejs`), `${kotlinDir}service/AuditEventService.kt`);
            }
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/service/dto/PasswordChangeDTO.java.ejs`), `${javaDir}service/dto/PasswordChangeDTO.java`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/web/rest/vm/ManagedUserVM.java.ejs`), `${javaDir}web/rest/vm/ManagedUserVM.java`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/AccountResource.kt.ejs`), `${javaDir}web/rest/AccountResource.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/UserResource.kt.ejs`), `${javaDir}web/rest/UserResource.kt`);
            if (this.searchEngine === 'elasticsearch') {
                this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/repository/search/UserSearchRepository.java.ejs`), `${javaDir}repository/search/UserSearchRepository.java`);
            }
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/service/mapper/package-info.java.ejs`), `${javaDir}service/mapper/package-info.java`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/service/mapper/UserMapper.kt.ejs`), `${javaDir}service/mapper/UserMapper.kt`);

            if (this.databaseType === 'sql' || this.databaseType === 'mongodb' || this.databaseType === 'couchbase') {
                this.template(rewriteDir(`${SERVER_MAIN_SRC_KOTLIN_DIR}package/web/rest/AuditResource.kt.ejs`), `${javaDir}web/rest/AuditResource.kt`);
            }
