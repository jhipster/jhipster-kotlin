    ...
    return {
        ...
        writeServerJavaAuthConfigFiles() {
            ...
            if (this.authenticationType === 'oauth2') {
                ...
                this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/security/DomainUserDetailsService.kt.ejs`), `${kotlinDir}security/DomainUserDetailsService.kt`);
        ...
        writeServerJavaAppFiles() {
            // Create Java files
            // Spring Boot main
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/Application.kt.ejs`), `${kotlinDir}/${this.mainClass}.kt`);
        },

        writeServerJavaConfigFiles() {
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/aop/logging/LoggingAspect.kt.ejs`), `${kotlinDir}aop/logging/LoggingAspect.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/config/DefaultProfileUtil.kt.ejs`), `${kotlinDir}config/DefaultProfileUtil.kt`);
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/config/DateTimeFormatConfiguration.kt.ejs`), `${kotlinDir}config/DateTimeFormatConfiguration.kt`);
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/config/LoggingConfiguration.kt.ejs`), `${kotlinDir}config/LoggingConfiguration.kt`);
        ...
        writeServerJavaServiceFiles() {
            ...
            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/service/util/RandomUtil.java.ejs`), `${kotlinDir}service/util/RandomUtil.java`);
        },
            ...
            if (this.skipUserManagement) {
                if (this.authenticationType === 'oauth2') {
                    ...
                    if (this.applicationType === 'monolith') {
                        ...
                        this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/repository/UserRepository.java.ejs`), `${kotlinDir}repository/UserRepository.java`);
                        ...
                        if (this.databaseType === 'sql' || this.databaseType === 'mongodb') {
                            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/repository/CustomAuditEventRepository.kt.ejs`), `${kotlinDir}repository/CustomAuditEventRepository.kt`);
                            this.template(rewriteDir(`${SERVER_MAIN_SRC_DIR}package/repository/AuthorityRepository.kt.ejs`), `${kotlinDir}repository/AuthorityRepository.kt`);
