...
module.exports = class extends BaseGenerator {
    ...
    writing() {
        ...
        this.template(
            ...
            `${SERVER_MAIN_SRC_DIR + this.packageFolder}/service/${this.serviceClass}Service.kt`
        );

        if (this.useInterface) {
            this.template(
                `${SERVER_MAIN_SRC_DIR}package/service/impl/ServiceImpl.kt.ejs`,
                `${SERVER_MAIN_SRC_DIR + this.packageFolder}/service/impl/${this.serviceClass}ServiceImpl.kt`
            );
        }
    }
};
