...
const constants = {
    ...
    jhipster7DockerContainers: {
        ...
        postgresql: DOCKER_POSTGRESQL,
        mongodb: DOCKER_MONGODB,
        couchbase: DOCKER_COUCHBASE,
        cassandra: DOCKER_CASSANDRA,
        mssql: DOCKER_MSSQL,
        neo4j: DOCKER_NEO4J,
        hazel: DOCKER_HAZELCAST_MANAGEMENT_CENTER,
        memcached: DOCKER_MEMCACHED,
        redis: DOCKER_REDIS,
        elasticsearch: DOCKER_ELASTICSEARCH,
        keycloak: DOCKER_KEYCLOAK,
        kafka: DOCKER_KAFKA,
        zookeeper: DOCKER_ZOOKEEPER,
        sonar: DOCKER_SONAR,
        consul: DOCKER_CONSUL,
        prometheus: DOCKER_PROMETHEUS,
        alertmanager: DOCKER_PROMETHEUS_ALERTMANAGER,
        grafana: DOCKER_GRAFANA,
        zipkin: DOCKER_ZIPKIN,
        jenkins: DOCKER_JENKINS,
        swagger: DOCKER_SWAGGER_EDITOR,
        prometheusOperator: DOCKER_PROMETHEUS_OPERATOR,
        grafanaWatcher: DOCKER_GRAFANA_WATCHER,
    },
