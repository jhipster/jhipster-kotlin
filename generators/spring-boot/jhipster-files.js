...
const { DOCKER_DIR, TEST_DIR, SERVER_MAIN_RES_DIR, SERVER_MAIN_SRC_DIR, SERVER_TEST_RES_DIR, SERVER_TEST_SRC_DIR } = jhipsterConstants;
...
const baseServerFiles = {
    ...
    docker: [
        ...
        {
            condition: generator =>
                generator.serviceDiscoveryAny || generator.applicationTypeGateway || generator.applicationTypeMicroservice,
            path: DOCKER_DIR,
            ...
            templates: [
                {
                    ...
                    renameTo: ctx => `${ctx.javaDir}domain/${ctx.user.persistClass}.java`,
                },
            ],
        },
        {
        ...
        },
        {
            ...
            templates: [
                ...
                },
                {
                    ...
                    renameTo: generator => `${generator.javaDir}service/dto/${generator.user.restClass}.java`,
                },
            ],
        },
        {
