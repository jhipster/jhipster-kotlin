 ...
 */
const { createBaseNeedle } = require('generator-jhipster/lib/support/needles.cjs');
...
const insertContentIntoApplicationProperties = (generator, needles) => {
    ...
    return createBaseNeedle(
        {
            generator,
            filePath: generator ? `${generator.SERVER_MAIN_SRC_DIR}kotlin/config/ApplicationProperties.kt` : undefined,
