...
const angularJson = readFileSync(new URL('../templates/workflow-samples/angular.json', import.meta.url), 'utf8');
const angularWorkflowSamples = JSON.parse(angularJson).include;

const reactJson = readFileSync(new URL('../templates/workflow-samples/react.json', import.meta.url), 'utf8');
