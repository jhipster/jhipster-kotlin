...
const expectedFiles = {
    ...
    server: [
        ...
        // TODO: This was added in JHipster 6.x
        ...
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/package-info.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/package-info.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/BadRequestAlertException.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/CustomParameterizedException.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/InternalServerErrorException.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/EmailAlreadyUsedException.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/ErrorConstants.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/ExceptionTranslator.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/FieldErrorVM.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/InvalidPasswordException.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/errors/LoginAlreadyUsedException.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/vm/package-info.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/vm/LoggerVM.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/package-info.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/LogsResource.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/security/SecurityUtilsUnitTest.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/LogsResourceIT.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/TestUtil.java`,
    ...
    userManagementServer: [
        ...
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/AuditEventService.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/MailService.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/UserService.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/util/RandomUtil.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/dto/package-info.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/dto/UserDTO.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/mapper/package-info.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/service/mapper/UserMapper.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/AccountResource.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/AuditResource.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/UserResource.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/vm/KeyAndPasswordVM.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/vm/ManagedUserVM.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/AccountResourceIT.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/AuditResourceIT.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/UserResourceIT.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/service/UserServiceIT.java`
    ],
    ...
    gateway: [
        ...
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/gateway/ratelimiting/RateLimitingFilter.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/vm/RouteVM.java`,
        `${SERVER_MAIN_SRC_DIR_JAVA}com/mycompany/myapp/web/rest/GatewayResource.java`,
    ...
    cucumber: [
        ...
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/cucumber/CucumberContextConfiguration.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/cucumber/stepdefs/UserStepDefs.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/cucumber/stepdefs/StepDefs.java`,
        `${SERVER_TEST_SRC_DIR_JAVA}com/mycompany/myapp/cucumber/CucumberIT.java`
    ],
